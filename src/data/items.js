...
export const ITEMS = {
  ...
  chocolate: { name: 'Chocolate', icon: 'chocolate', kind: 'food', hunger: 10, energy: 15, flavor: 'Bloomed white with age. Still chocolate. Still morale.' },
  ...
  soda: { name: 'Flat soda', icon: 'soda', kind: 'drink', hunger: 6, energy: 12, flavor: 'Warm, flat, and somehow still a small occasion.' },
  ...
  crowbar: { name: 'Crowbar', icon: 'crowbar', kind: 'tool', flavor: 'Opens doors, arguments, and possibilities.' },
